...
const MainMenuButton: React.FC<MainMenuButtonProps> = ({
  ...
  return (
    <div className="relative flex flex-col justify-center items-center group">
      <hr
        tabIndex={0}
        className="absolute border-t-4 border-white z-3 invisible group-hover:visible transition-all duration-800 ease-in-out 
      ...
      <Link
        ...
        className="w-sm text-center text-2xl bg-neutral-300 hover:bg-white hover:shadow-m hover:scale-110
                text-black py-3 px-5 rounded-md shadow-gray-700 transition-all active:bg-neutral-700 duration-300 active:scale-95 ease-in-out z-4
